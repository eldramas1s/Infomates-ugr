...
public class Dice { 
    ...
    static private float PROB_GONUTS=0.1f;
    /**
    ...
    static public Directions nextStepGoNuts(Directions preference, ArrayList<Directions> validMoves){
        Directions result;
        if(generator.nextFloat()>=PROB_GONUTS){
            result=preference;
        }
        else{
