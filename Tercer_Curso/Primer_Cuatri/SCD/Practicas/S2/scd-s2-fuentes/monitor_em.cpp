...
class MContador2 : public HoareMonitor //Esta es la única diferencia con el monitor 1 dando lugar a que no produzca la exclusion mutua estamos poniendo herencia
{
   private:
   int cont ;
