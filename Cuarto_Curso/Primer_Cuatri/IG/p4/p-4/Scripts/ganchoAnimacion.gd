...
# Tal y como lo he pensado, los limites que he pensado es sobre el brazo, es decir,
# como el brazo esta rotado, el eje que pensamos es realmente el eje z en el marco del brazo.
# Y asi sucesivamente. De esta forma, high_limit es realmente low_limit pensando en el marco del gancho
...
#? DUDA: como hago lo de la homotecia
var homothety:= false
