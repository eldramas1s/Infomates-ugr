...
Por último, cabe destacar que he usado el cálculo de la componente $v$ en función del desplazamiento en el perfil, en este caso, en función del radio. No obstante, en el script \textit{Utilidades} aparece la función del cálculo de la misma componente en función de la altura en el perfil. Es, por último, claro que la aproximación por el primer método debe ser mejor debido a la geometría del toroide.
