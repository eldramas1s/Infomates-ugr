    ...
    <main class="viajesCuadricula">
        ...
        <section class="viajes" id="grupo1">
            ...
            <article class="viajeTipo">
                ...
                <p class="precio"><strong>850€</strong></p>
            </article>
            ...
            <article class="viajeTipo">
                ...
                <form action="../html/viajes.php" method="post"
                    ...
                    <select name="fecha" class="selectorFecha">
                        <option value="null">Seleccione fecha</option>
                        <option
                            value="0603;0604">6/03/2026-6/04/2026</option>
                        <option
                            value="0509;1009">5/9/2026-10/9/2026</option>
                    </select>
                </form>
                <p class="precio"><strong>3500€</strong></p>
            </article>
            ...
            <article class="viajeTipo">
                ...
                <p class="precio"><strong>650€</strong></p>
            </article>
            ...
            <article class="viajeTipo">
                ...
                <p class="precio"><strong>4500€</strong></p>
            </article>
            ...
            <article class="viajeTipo">
                ...
                <form action="../html/viajes.php" method="post"
                    ...
                    <select name="fecha" class="selectorFecha">
                        <option value="null">Seleccione fecha</option>
                        <option
                            value="1404;2004">14/04/2026-20/04/2026</option>
                        <option
                            value="0105;0805">1/05/2026-8/05/2026</option>
                    </select>
                </form>
            ...
            <article class="viajeTipo">
                ...
                <p class="precio"><strong>2000€</strong></p>
            </article>
            ...
            <article class="viajeTipo">
                ...
                <p class="precio"><strong>1000€</strong></p>
            </article>
            ...
            <article class="viajeTipo">
                ...
                <p class="precio"><strong>2050€</strong></p>
            </article>
        </section>
        ...
        <?php if (isset($_SESSION['admin']) && $_SESSION['admin'] === true): ?>
            ...
            <form id="countryForm" action="addTrip.php" method="post">
                <div class="field">
                    ...
                    <input type="text" id="continente" name="continente" list="continentes">
                </div>
                <div class="field">
                    <label for="paisViaje" name="pais">Pais</label>
                    <input type="text" name="pais" id="paisViaje" list="paises">
                ...
                <div class="field">
                    <label for="fechaSalida" name="date">Fecha</label>
                    <input type="date" name="departureDate" id="fechaSalida" min=<?php echo date('Y-m-d'); ?>>
                </div>
                <div class="field">
                    <label for="fechaVuelta" name="date">Fecha</label>
                    <input type="date" name="returnDate" id="fechaVuelta">
                </div>
                <div class="field">
                    <label for="imagenViaje">Nombre de la imagen</label>
                    <input type="text" name="imagen" id="imagenViaje" placeholder="ejemplo.jpg">
                </div>
            </form>
            <script src="../js/getPaises.js" type="module"></script>
        <?php endif; ?>
    </main>
    <footer>
        <nav id="menuFooter">
